...
const imageMap: Record<string, string> = {
  ...
  'courtyard': 'interior_bedroom1',
  'living-room': 'interior_living1',
  'staircase': 'furniture1',
  'skyscraper': 'shop_interior1',
  'atrium': 'retail_display1',
  'façade': 'shop_interior2',
  'facade': 'shop_interior2',
  'sky-garden': 'retail_display2',
  'desert-home': 'interior_living2',
  'minimal-interior': 'interior_bedroom1',
  'pool': 'interior_bathroom1',
  'jaali': 'furniture2',
  'museum': 'retail_display1',
  'gallery': 'retail_display2',
  'heritage': 'shop_interior1',
  'stone-carving': 'furniture1',
  'resort': 'interior_living1',
  'villa': 'interior_living2',
  'beach': 'interior_kitchen1',
  'pool-resort': 'interior_bathroom1',
  'office-campus': 'shop_interior1',
  'courtyard-office': 'shop_interior2',
  'glass-facade': 'retail_display1',
  'collaboration': 'interior_kitchen2',
  'promenade': 'retail_display2',
  'public-space': 'shop_interior1',
  'riverfront': 'retail_display1',
  'plaza': 'retail_display2',
  'hospital': 'interior_bedroom1',
  'courtyard-hospital': 'interior_living1',
  'garden': 'interior_kitchen1',
  'light-well': 'interior_bathroom1',
  'parametric': 'retail_display2',
  'pavilion': 'shop_interior2',
  'expo': 'retail_display1',
  'timber-structure': 'furniture2',
  'school': 'shop_interior1',
  'classroom': 'interior_living1',
  'amphitheatre': 'retail_display2',
  'library': 'interior_kitchen2',
  'temple': 'retail_display1',
  'courtyard-temple': 'shop_interior2',
  'ghat': 'retail_display2',
  'procession': 'shop_interior1',
  'mall': 'retail_display1',
